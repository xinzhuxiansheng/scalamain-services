...
object Resources extends ZIOAppDefault {
  ...
  val fetchWithScopedResource = ZIO.scoped(fetchWithResoure)
  ...
  /**
   * Exercises
   * 1. Use the acquireRelease to open a file, print all lines,(one very 100 millis), then close the file
   */
